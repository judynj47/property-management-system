page 50172 "Receipt List"
{
    ...
    actions
    {
        area(Processing)
        {
            action(CreateNewReceipt)
            {
                ...
                begin
                    RentInvoice.Init();
                    RentInvoice."Document Type" := RentInvoice."Document Type"::Receipt;
    ...
    trigger OnOpenPage()
    begin
        // Ensure we're only showing receipts
        Rec.SetRange("Document Type", Rec."Document Type"::Receipt);
    end;
}